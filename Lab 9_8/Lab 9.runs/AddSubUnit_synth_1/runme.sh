...
HD_PWD='E:/Projects/VivadoProjects/Lab 9_Team/Lab 9_8/Lab 9.runs/AddSubUnit_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log AddSubUnit.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source AddSubUnit.tcl
